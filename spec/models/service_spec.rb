...
describe Service do
  ...
  describe 'validation' do
    ...
    describe '#deploy_key' do
      ...
      context 'when not a key' do
        it 'is not valid' do
          subject.deploy_key = 'foo'
          subject.valid?
      ...
      context 'when a private key' do
        it 'is valid' do
          subject.deploy_key = <<-KEY.chomp
-----BEGIN RSA PRIVATE KEY-----

-----END RSA PRIVATE KEY-----
KEY
          subject.valid?
          expect(subject.errors[:deploy_key]).to be_blank
